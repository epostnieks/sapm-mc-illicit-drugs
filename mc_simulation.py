#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Illicit Drug Trade / Prohibition Profit Floor
=============================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Illicit Drug Trade (Prohibition Profit Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "illicit_drugs",
    "domain_name": "Illicit Drug Trade",
    "theorem": "Prohibition Profit Floor",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 275.0,
    "channels": {
        "C1_public_health": {
            "dist": "lognormal",
            "low": 1800,
            ...
            "high": 3200,
            "weight": 0.35,
            "description": "Overdose deaths, addiction treatment, disease transmission"
        },
        "C2_violence_capture": {
            "dist": "lognormal",
            "low": 350,
            ...
            "high": 500,
            "weight": 0.2,
            "description": "Cartel violence, state capture, homicides"
        },
        "C3_criminal_justice": {
            "dist": "normal",
            "low": 180,
            ...
            "high": 280,
            "weight": 0.15,
            "description": "Incarceration, policing, courts"
        },
        "C4_money_laundering": {
            "dist": "lognormal",
            "low": 150,
            ...
            "high": 350,
            "weight": 0.12,
            "description": "Financial system distortion, laundering costs"
        },
        "C5_producer_country": {
            "dist": "lognormal",
            "low": 100,
            ...
            "high": 250,
            "weight": 0.1,
            "description": "Development destruction in producer countries"
        },
        "C6_governance": {
            "dist": "lognormal",
            "low": 60,
            ...
            "high": 160,
            "weight": 0.08,
            "description": "Institutional failure, corruption, regulatory evasion"
        }
    },
